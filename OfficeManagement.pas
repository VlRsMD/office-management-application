...
type
  TOfficeManagementForm = class(TForm)
    MultiView1: TMultiView;
    Layout1: TLayout;
    ListView1: TListView;
    StaffToolbar: TToolBar;
    StaffLabel: TLabel;
...
var
  OfficeManagementForm: TOfficeManagementForm;

implementation

{$R *.fmx}

procedure TOfficeManagementForm.ListView1ItemClick(const Sender: TObject; const AItem: TListViewItem);
begin
